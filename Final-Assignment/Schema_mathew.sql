...
CREATE TABLE [User] (
    ...
    CONSTRAINT UQ_User_profileUrl UNIQUE (profileUrl)
);
...
CREATE TABLE [Message] (
    ...
    CONSTRAINT FK_Message_User_senderId FOREIGN KEY (senderId)
        REFERENCES [User](userId)
        ON DELETE CASCADE,
    CONSTRAINT FK_Message_User_receiverId FOREIGN KEY (receiverId)
        REFERENCES [User](userId)
);
...
CREATE TABLE Follower (
    ...
    CONSTRAINT UQ_Follower_userId_followerId UNIQUE (userId, followerId),
    CONSTRAINT FK_Follower_User_userId FOREIGN KEY (userId)
        REFERENCES [User](userId)
        ON DELETE CASCADE,
    CONSTRAINT FK_Follower_User_followerId FOREIGN KEY (followerId)
        REFERENCES [User](userId)
);
...
CREATE TABLE [View] (
    ...
    postId NVARCHAR(22) NOT NULL,
    [timestamp] DATETIME NOT NULL,
    CONSTRAINT PK_View_viewId PRIMARY KEY (viewId),
    CONSTRAINT FK_View_User_userId FOREIGN KEY (userId)
        REFERENCES [User](userId)
        ON DELETE CASCADE,
    CONSTRAINT FK_View_Post_postId FOREIGN KEY (postId)
...
CREATE TABLE [Like] (
    ...
    CONSTRAINT FK_Like_User_userId FOREIGN KEY (userId)
        REFERENCES [User](userId)
        ON DELETE CASCADE,
    CONSTRAINT FK_Like_Post_postId FOREIGN KEY (postId)
        REFERENCES Post(postId)
);
...
CREATE TABLE [Image] (
    ...
    CONSTRAINT UQ_Image_postId_imageUrl UNIQUE (postId, imageUrl),
    CONSTRAINT FK_Image_Post_postId FOREIGN KEY (postId)
        REFERENCES Post(postId)
        ON DELETE CASCADE
);
...
CREATE TABLE Tag (
    ...
    CONSTRAINT FK_Tag_Post_postId FOREIGN KEY (postId)
        REFERENCES Post(postId)
        ON DELETE CASCADE,
    CONSTRAINT FK_Tag_User_userId FOREIGN KEY (userId)
        REFERENCES [User](userId),
    CONSTRAINT UQ_Tag_postId_userId UNIQUE (postId, userId)
);
GO
